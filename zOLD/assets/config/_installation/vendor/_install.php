...
if (!file_exists($db_sqlite_path)) {
    // echo "Database $file was created, installation was successful.";
    echo "Database $db_sqlite_path was not created, installation was NOT successful. Missing folder write rights ?";
} else {
    // echo "Database $file was not created, installation was NOT successful. Missing folder write rights ?";
