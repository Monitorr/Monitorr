                ...
                calculateName: function () {
                    if (!this.name || this.name && this.nameCalculated)
                        if (this.parent && this.parent.name && this.path) {
                            var e = this.path.substring(this.path.lastIndexOf("/") + 1); - 1 !== e.indexOf("[") && -1 !== e.indexOf("]") && (e = e.substring(e.indexOf("[") + 1, e.indexOf("]"))), e && (this.name = this.parent.name + "[" +  + "]" + e, this.nameCalculated = !0)
            ...
            t.registerView({
                ...
                messages: {
                    cs_CZ: {
                        ...
                        invalidValueOfEnum: "Toto pole musÃ­ obsahovat jednu hodnotu z {0}. AktuÃ¡lnÃ­ hodnota je: {1}",
                        ...
                        stringValueTooSmallExclusive: "Hodnota tohoto pole musÃ­ bÃ½t vÄ›tÅ¡Ã­ neÅ¾ {0}",
                        stringValueTooLargeExclusive: "Hodnota tohoto pole musÃ­ bÃ½t menÅ¡Ã­ neÅ¾ {0}",
                        ...
                        tooManyProperties: "MaximÃ¡lnÃ­ poÄet vlastnostÃ­ ({0}) byl pÅ™ekroÄen.",
                        tooFewProperties: "NenÃ­ dostatek vlastnostÃ­ (je poÅ¾adovÃ¡no {0})",
                        ...
                        editorAnnotationsExist: "Editor mÃ¡ v sobÄ› chyby, kterÃ© musÃ­ bÃ½t opraveny",
                        ...
                        dropZoneSingle: "Vyberte soubor nebo jej pÅ™etÃ¡hnÄ›te sem pro nahrÃ¡nÃ­...",
                        dropZoneMultiple: "Vyberte soubory nebo je pÅ™etÃ¡hnÄ›te sem pro nahrÃ¡nÃ­...",
                        invalidURLFormat: "UvedenÃ¡ URL nenÃ­ platna webovÃ¡ adresa.",
                        invalidZipcodeFormatFive: "ChybnÃ© poÅ¡tovnÃ­ smÄ›rovacÃ­ ÄÃ­slo (#####)",
                        invalidZipcodeFormatNine: "ChybnÃ© devÃ­ti-mÃ­stnÃ© poÅ¡tovnÃ­ smÄ›rovacÃ­ ÄÃ­slo (#####-####)"
                    }
                }
            })
        }(jQuery),
            ...
            t.registerView({
                ...
                messages: {
                    de_DE: {
                        ...
                        stringValueTooSmallExclusive: "Die kleinstmÃ¶gliche Zahl muss grÃ¶ÃŸer sein als {0}",
                        stringValueTooLargeExclusive: "Die grÃ¶sstmÃ¶gliche Zahl muss kleiner sein als {0}",
                        stringDivisibleBy: "Der Wert muss durch {0} dividierbar sein",
                        stringNotANumber: "Die Eingabe ist keine Zahl",
                        invalidPassword: "UngÃ¼ltiges Passwort",
            ...
            t.registerView({
                ...
                messages: {
                    el_GR: {
                        ...
                        notOptional: "Î‘Ï…Ï„ÏŒ Ï„Î¿ Ï€ÎµÎ´Î¯Î¿ Î´ÎµÎ½ ÎµÎ¯Î½Î±Î¹ Ï€ÏÎ¿Î±Î¹ÏÎµÏ„Î¹ÎºÏŒ",
                        disallowValue: "ÎœÎ· ÎµÏ€Î¹Ï„ÏÎµÏ€Ï„Î® Ï„Î¹Î¼Î®: {0}",
                        invalidValueOfEnum: "Î¤Î¿ Ï€ÎµÎ´Î¯Î¿ Ï€ÏÎ­Ï€ÎµÎ¹ Î½Î± Ï€ÎµÏÎ¹Î­Ï‡ÎµÎ¹ Î¼Î¯Î± Î±Ï€ÏŒ Ï„Î¹Ï‚ Î±ÎºÏŒÎ»Î¿Ï…Î¸ÎµÏ‚ Ï„Î¹Î¼Î­Ï‚: {0}. [{1}]",
                        notEnoughItems: "ÎŸ ÎµÎ»Î¬Ï‡Î¹ÏƒÏ„Î¿Ï‚ Î±ÏÎ¹Î¸Î¼ÏŒÏ‚ ÎµÎ³Î³ÏÎ±Ï†ÏŽÎ½ ÎµÎ¯Î½Î±Î¹ {0}",
                        tooManyItems: "ÎŸ Î¼Î­Î³Î¹ÏƒÏ„Î¿Ï‚ Î±ÏÎ¹Î¸Î¼ÏŒÏ‚ ÎµÎ³Î³ÏÎ±Ï†ÏŽÎ½ ÎµÎ¯Î½Î±Î¹ {0}",
                        valueNotUnique: "ÎŸÎ¹ Ï„Î¹Î¼Î­Ï‚ Î´ÎµÎ½ ÎµÎ¯Î½Î±Î¹ Î¼Î¿Î½Î±Î´Î¹ÎºÎ­Ï‚",
                        ...
                        stringValueTooSmall: "Î¤Î¿ ÎµÎ»Î¬Ï‡Î¹ÏƒÏ„Î¿ Ï€Î»Î®Î¸Î¿Ï‚ Ï‡Î±ÏÎ±ÎºÏ„Î®ÏÏ‰Î½ ÎµÎ¯Î½Î±Î¹ {0}",
                        stringValueTooLarge: "Î¤Î¿ Î¼Î­Î³Î¹ÏƒÏ„Î¿ Ï€Î»Î®Î¸Î¿Ï‚ Ï‡Î±ÏÎ±ÎºÏ„Î®ÏÏ‰Î½ ÎµÎ¯Î½Î±Î¹ {0}",
                        stringValueTooSmallExclusive: "Î‘Ï€Î±Î¹Ï„Î¿ÏÎ½Ï„Î±Î¹ Ï€ÎµÏÎ¹ÏƒÏƒÏŒÏ„ÎµÏÎ¿Î¹ Ï‡Î±ÏÎ±ÎºÏ„Î®ÎµÏ‚ Î±Ï€ÏŒ {0}",
                        stringValueTooLargeExclusive: "Î‘Ï€Î±Î¹Ï„Î¿ÏÎ½Ï„Î±Î¹ Î»Î¹Î³ÏŒÏ„ÎµÏÎ¿Î¹ Ï‡Î±ÏÎ±ÎºÏ„Î®ÏÎµÏ‚ Î±Ï€ÏŒ {0}",
                        stringDivisibleBy: "Î— Ï„Î¹Î¼Î® Ï€ÏÎ­Ï€ÎµÎ¹ Î½Î± ÎµÎ¯Î½Î±Î¹ Ï€Î¿Î»Î»Î±Ï€Î»Î¬ÏƒÎ¹Î¿ Ï„Î¿Ï… {0}",
                        ...
                        invalidPattern: "Î‘Ï…Ï„ÏŒ Ï„Î¿ Ï€ÎµÎ´Î¯Î¿ Î´ÎµÎ½ Î­Ï‡ÎµÎ¹ Ï„Î·Î½ Î±Ï€Î±Î¹Ï„Î¿ÏÎ¼ÎµÎ½Î· Î¼Î¿ÏÏ†Î® {0}",
                        stringTooShort: "Î¤Î¿ Ï€ÎµÎ´Î¯Î¿ Ï€ÏÎ­Ï€ÎµÎ¹ Î½Î± Î­Ï‡ÎµÎ¹ Ï„Î¿Ï…Î»Î¬Ï‡Î¹ÏƒÏ„Î¿Î½ {0} Ï‡Î±ÏÎ±ÎºÏ„Î®ÏÎµÏ‚",
                        stringTooLong: "Î¤Î¿ Ï€ÎµÎ´Î¯Î¿ Î¼Ï€Î¿ÏÎµÎ¯ Î½Î± Î­Ï‡ÎµÎ¹ Ï„Î¿ Ï€Î¿Î»Ï {0} Ï‡Î±ÏÎ±ÎºÏ„Î®ÏÎµÏ‚"
                    }
                }
            })
        }(jQuery),
            ...
            t.registerView({
                ...
                messages: {
                    fi_FI: {
                        ...
                        invalidValueOfEnum: "KentÃ¤n pitÃ¤Ã¤ sisÃ¤ltÃ¤Ã¤ yksi seuraavista arvoista: {0}. [{1}]",
                        ...
                        stringValueTooSmallExclusive: "Arvon pitÃ¤Ã¤ olla suurempi kuin {0}",
                        stringValueTooLargeExclusive: "Arvon pitÃ¤Ã¤ olla pienempi kuin {0}",
            ...
            t.registerView({
                ...
                messages: {
                    nb_NO: {
                        ...
                        invalidValueOfEnum: "Feltet mÃ¥ inneholde en av fÃ¸lgende verdier: {0}. NÃ¥vÃ¦rende verdi er: {1}",
            ...
            t.registerView({
                ...
                messages: {
                    nl_BE: {
                        ...
                        invalidValueOfEnum: "Dit veld moet Ã©Ã©n van volgende bevatten : {0}. [{1}]",
            ...
            t.registerView({
                ...
                messages: {
                    sv_SE: {
                        ...
                        invalidValueOfEnum: "FÃ¤ltet mÃ¥ste innehÃ¥lla ett av fÃ¶ljande vÃ¤rden: {0}. [{1}]",
